var aep_file_index = new File("C:/Users/ryo08/Desktop/AE/After_effects_test.aep"); // aepファイルのパス
...
var csv_file_index = File("C:/Users/ryo08/Desktop/AE/image/tag_data.csv");
...
for (var i = 0; i < csv_data.length; i++) {
    ...
    var img_file_index = new File("C:/Users/ryo08/Desktop/AE/" + csv_data[i][0]);
...
var output_index = File("C:/Users/ryo08/Desktop/AE/test_mp4.mp4"); // 動画を出力する場所
...
function EFFECT_NOTES_MODULE(test_layers_index, start_time, end_time) {
    ...
    var notes_img_index = new File("C:/Users/ryo08/Desktop/AE/effects_img/onp_v2.png"); // imgファイルのパス
...
function EFFECT_HEART_MODULE(test_layers_index, start_time, end_time) {
    ...
    var heart_img_index = new File("C:/Users/ryo08/Desktop/AE/effects_img/heart.png"); // imgファイルのパス
